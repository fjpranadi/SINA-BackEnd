...
// Route siswaa
router.post('/admin/siswa',verifyAdmin, upload.single('fotoProfil'), tambahSiswa); // Tambah siswa
...
router.put('/admin/siswa/:nis',verifyAdmin, upload.single('fotoProfil'), updateSiswa);                       // Update siswa
